...
# Pre-download spaCy model during build (CRITICAL: avoid runtime download timeout)
...
# Run the application WITHOUT trying to download spaCy (it's already in the image)
